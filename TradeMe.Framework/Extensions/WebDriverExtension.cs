...
namespace TradeMe.Framework.Extensions
{
    public static class WebDriverExtension
    {
        ...
        public static void WaitForPageLoaded(this IWebDriver driver, string pageTitle, int timeOutinSeconds = 20)
        {
            try
            {
                var wait = new WebDriverWait(driver, TimeSpan.FromSeconds(timeOutinSeconds));
        ...
        public static bool VerifyFilteredResults<TKey, TValue>(this IWebDriver driver, Func<IDictionary<TKey, TValue>, bool> verifyOnEachPage, IDictionary<TKey, TValue> filter)
        {
            ...
            {               
                //if (Pages[i].Enabled && Pages[i].Displayed)
                //{
                    Console.WriteLine("Clicking on page:"+Pages[i]);
